* =============================================================================
* v6gleambl_agg_nomwet_macros_include.do
* Purpose: Shared macros for GGCP10 aggregated-area GLEAM nomwet full-family rerun.
* =============================================================================
...
global v6nbase_dta "$projdir/temp/2026-05-18_ggcp10_harvarea_agg_baseline_suite/v3_analysis_ready_ggcp10_harvarea_agg.dta"

cap mkdir "$v6rundir"
cap mkdir "$logdir"

global v6nready_dta "$v6rundir/v6gleambl_agg_nomwet_analysis_ready.dta"
global v6ndiag_csv "$outdir/v6gleambl_agg_nomwet_diagnostics.csv"
global v6ncoef_csv "$outdir/v6gleambl_agg_nomwet_baseline_coefficients.csv"
...
di "=== v6gleambl_agg_nomwet_macros_include.do loaded ==="
