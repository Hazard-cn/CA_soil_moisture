* =============================================================================
* v6gleambl_nowet_nop30_step1_model8.do
* Purpose: Run GLEAM baseline regressions without M_wet/W_w and excluding
*          v3pre30.
* =============================================================================
...
log using "$logdir/v6gleambl_nowet_nop30_step1_model8.log", replace

use "$v6xready_dta", clear
xtset grid_id year
...
postfile `pf' str12 module str12 window str20 metric_family str4 dry_pct ///
    ...
    using "$outdir/v6gleambl_nowet_nop30_coef_raw.dta", replace
...
forvalues m = 1/3 {
    ...
    forvalues w = 1/3 {
        ...
        forvalues s = 1/2 {
            ...
            local mediator "v6x`tag'_`src'"

            reghdfe `mediator' `d_var' ca `srd_var' ///
            ...
            reghdfe ln_yield `d_var' ca `srd_var' `mediator' ///
                $V6_CTRL_FULL if `sample_var' == 1, ///
                absorb(grid_id year) vce(cluster grid_id)
...
preserve
use "$outdir/v6gleambl_nowet_nop30_coef_raw.dta", clear
export delimited using "$v6xcoef_csv", replace
restore

cap erase "$outdir/v6gleambl_nowet_nop30_coef_raw.dta"

log close
di "=== v6gleambl_nowet_nop30_step1_model8.do COMPLETE ==="
