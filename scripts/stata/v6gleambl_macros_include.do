* =============================================================================
* v6gleambl_macros_include.do
* Purpose: Shared macros for four-window GLEAM baseline-local Model 8 rerun.
* =============================================================================
...
global v6base_dta "$datadir/v3_analysis_ready.dta"

cap mkdir "$v6rundir"
cap mkdir "$logdir"

global v6ready_dta "$v6rundir/v6gleambl_analysis_ready.dta"
global v6diag_csv "$v6rundir/v6gleambl_diagnostics.csv"
global v6coef_csv "$v6rundir/v6gleambl_baseline_coefficients.csv"
global v6boot_csv "$v6rundir/v6gleambl_bootstrap_iede_te.csv"
...
di "=== v6gleambl_macros_include.do loaded ==="
