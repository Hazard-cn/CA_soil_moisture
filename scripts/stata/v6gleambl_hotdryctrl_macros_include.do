* =============================================================================
* v6gleambl_hotdryctrl_macros_include.do
* Purpose: Shared macros for four-window GLEAM hot-dry-main baseline rerun.
* =============================================================================
...
global v6qbase_dta "$datadir/v3_analysis_ready.dta"

cap mkdir "$v6rundir"
cap mkdir "$logdir"

global v6qready_dta "$v6rundir/v6gleambl_hotdryctrl_analysis_ready.dta"
global v6qdiag_csv "$outdir/v6gleambl_hotdryctrl_diagnostics.csv"
global v6qcoef_csv "$outdir/v6gleambl_hotdryctrl_baseline_coefficients.csv"
...
di "=== v6gleambl_hotdryctrl_macros_include.do loaded ==="
