* =============================================================================
* v6gleambl_heatctrl_macros_include.do
* Purpose: Shared macros for four-window GLEAM heat-main baseline rerun.
* =============================================================================
...
global v6hbase_dta "$datadir/v3_analysis_ready.dta"

cap mkdir "$v6rundir"
cap mkdir "$logdir"

global v6hready_dta "$v6rundir/v6gleambl_heatctrl_analysis_ready.dta"
global v6hdiag_csv "$outdir/v6gleambl_heatctrl_diagnostics.csv"
global v6hcoef_csv "$outdir/v6gleambl_heatctrl_baseline_coefficients.csv"
...
di "=== v6gleambl_heatctrl_macros_include.do loaded ==="
