* =============================================================================
* v6gleambl_agg_heatctrl_macros_include.do
* Purpose: Shared macros for GGCP10 aggregated-area GLEAM heat-main rerun.
* =============================================================================
...
global v6hbase_dta "$projdir/temp/2026-05-18_ggcp10_harvarea_agg_baseline_suite/v3_analysis_ready_ggcp10_harvarea_agg.dta"

cap mkdir "$v6rundir"
cap mkdir "$logdir"

global v6hready_dta "$v6rundir/v6gleambl_agg_heatctrl_analysis_ready.dta"
global v6hdiag_csv "$outdir/v6gleambl_agg_heatctrl_diagnostics.csv"
global v6hcoef_csv "$outdir/v6gleambl_agg_heatctrl_baseline_coefficients.csv"
...
di "=== v6gleambl_agg_heatctrl_macros_include.do loaded ==="
