* =============================================================================
* v6gleambl_agg_hotdryctrl_macros_include.do
* Purpose: Shared macros for GGCP10 aggregated-area GLEAM hotdry-main rerun.
* =============================================================================
...
global v6qbase_dta "$projdir/temp/2026-05-18_ggcp10_harvarea_agg_baseline_suite/v3_analysis_ready_ggcp10_harvarea_agg.dta"

cap mkdir "$v6rundir"
cap mkdir "$logdir"

global v6qready_dta "$v6rundir/v6gleambl_agg_hotdryctrl_analysis_ready.dta"
global v6qdiag_csv "$outdir/v6gleambl_agg_hotdryctrl_diagnostics.csv"
global v6qcoef_csv "$outdir/v6gleambl_agg_hotdryctrl_baseline_coefficients.csv"

global V6_CTRL_NOHEAT "pr_sum et0_sum gdd_10_30 irr_frac aridity"
...
di "=== v6gleambl_agg_hotdryctrl_macros_include.do loaded ==="
