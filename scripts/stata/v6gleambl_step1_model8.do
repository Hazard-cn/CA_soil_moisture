* =============================================================================
* v6gleambl_step1_model8.do
* Purpose: Run four-window GLEAM baseline-local Model 8 baseline regressions.
* Output:  temp/2026-04-23_newSMsplit/v6gleambl_baseline_coefficients.csv
* =============================================================================
...
log using "$logdir/v6gleambl_step1_model8.log", replace
...
postfile `pf' str12 module str12 window str20 metric_family str4 dry_pct ///
    ...
    using "$outdir/v6gleambl_coef_raw.dta", replace
...
forvalues m = 1/3 {
    ...
    forvalues w = 1/4 {
        ...
        forvalues s = 1/2 {
            ...
            di _n "============================================================"
            di "Running `tag' / `src' / N = " r(N)
            di "============================================================"

            reghdfe `mediator' `d_var' ca `srd_var' `wetmed' `w_var' ///
            ...
            reghdfe ln_yield `d_var' ca `srd_var' `mediator' `wetmed' `w_var' ///
                $V6_CTRL_FULL if `sample_var' == 1, ///
                absorb(grid_id year) vce(cluster grid_id)
...
preserve
use "$outdir/v6gleambl_coef_raw.dta", clear
export delimited using "$v6coef_csv", replace
restore

cap erase "$outdir/v6gleambl_coef_raw.dta"

log close
di "=== v6gleambl_step1_model8.do COMPLETE ==="
