* =============================================================================
* v6gleambl_heatctrl_step1_model8.do
* Purpose: Run four-window GLEAM baseline regressions with heat in main slot.
* =============================================================================
...
log using "$logdir/v6gleambl_heatctrl_step1_model8.log", replace

use "$v6hready_dta", clear
xtset grid_id year
...
postfile `pf' str12 module str12 window str20 metric_family str4 dry_pct ///
    ...
    using "$outdir/v6gleambl_heatctrl_coef_raw.dta", replace
...
forvalues m = 1/3 {
    ...
    forvalues w = 1/4 {
        ...
        forvalues s = 1/2 {
            ...
            local mediator "v6h`tag'_`src'"

            reghdfe `mediator' hdd_ge32 ca SR_x_Heat_full `d_var' `w_var' ///
            ...
            foreach pair in ///
                ...
                post `pf' ("heat") ("`wlbl'") ("`family'") (".") ///
                    (".") ("`src_layer'") ("`sm_label'") ("`tag'") ///
                    ("mediator") ("`term'") ("`reg'") ///
                    (_b[`reg']) (_se[`reg']) (`pval') (`nn_m') (`rr_m')
            }

            reghdfe ln_yield hdd_ge32 ca SR_x_Heat_full `mediator' `d_var' `w_var' ///
                $V6_CTRL_NOHEAT if `sample_var' == 1, ///
                absorb(grid_id year) vce(cluster grid_id)
...
preserve
use "$outdir/v6gleambl_heatctrl_coef_raw.dta", clear
export delimited using "$v6hcoef_csv", replace
restore

cap erase "$outdir/v6gleambl_heatctrl_coef_raw.dta"

log close
di "=== v6gleambl_heatctrl_step1_model8.do COMPLETE ==="
