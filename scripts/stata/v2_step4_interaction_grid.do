* =============================================================================
* v2_step4_interaction_grid.do
* Purpose: 4 specs x 3 SM sources x 5 windows = 40 regressions
*          Complete evidence matrix with postfile output
* Author:  YangSu + Claude
* Date:    2026-04-02
* Input:   data/processed/v2_analysis_ready.dta
* Output:  output/tables/v2_step4_interaction_grid.csv
* =============================================================================
...
log using "$logdir/v2_step4_interaction_grid_20260402.log", replace
...
postfile `pf' str10 window str6 spec str6 sm_src ///
    ...
    N r2 ///
    using "$outdir/v2_step4_interaction_grid.dta", replace

* =============================================================================
* LOOP OVER WINDOWS x SPECS x SM SOURCES
* =============================================================================

foreach win in full v3pm10 hepm10 v3he hema {
...
export delimited using "$outdir/v2_step4_interaction_grid.csv", replace
...
* For each window x SM source: attn = 1 - b_spec3 / b_spec1
preserve
gen attn_SRD = .
gen attn_SRH = .
...
export delimited using "$outdir/v2_step4_attenuation.csv", replace
restore

log close
di "=== v2_step4_interaction_grid.do COMPLETE ==="
