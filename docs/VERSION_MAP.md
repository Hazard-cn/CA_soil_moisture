...
| report-sr-method-portfolio-web-reader-v1 | 2026-07-17 | umbrella | public_web_reader_portfolio_index | Published a GitHub-native reading entry for the three empirical directions, the 37-paper method inventory and the later external-review corrections | Public web-reader and review entry; it does not produce a new empirical estimate | git-native |
...
| compound-event-intensity-duration-override-v1 | 2026-07-15 | reference | historical_internal_candidate_under_event_structure_revision | Continued the stopped smoke branch to full five-zone event, yield and soil-moisture analyses and made the triggered joint duration-intensity model the reviewed main specification | Historical internal candidate record with unresolved event-model Critical; not a current submission candidate | git-native |
...
| g185-old-method-unified-override-v1 | 2026-07-15 | reference | historical_internal_candidate_under_external_method_revision | Continued the previously stopped G185 branch under the user-authorized nonblocking stability gate and assembled the historical national, continuous regional and five-zone algebraic evidence into one reviewed candidate | Historical internal candidate record with unresolved external method Major; not a current submission candidate | git-native |
