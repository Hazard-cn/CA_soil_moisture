...
文件：`C:/YangSu/00_Project/CA_mechanism/data/master/data_v1_with_climate.csv`  
仓库内不存在 `data/processed/data_v1_with_climate.csv` 这一副本。  
...
- 异常值处理：根目录变量字典未定义统一 winsorize/trim 规则；各分析分支在自身脚本中记录转换口径
...
- 基础面板：`temp/2026-05-18_ggcp10_harvarea_agg_baseline_suite/ggcp10_baseline_suite_analysis_ready.dta`
- 热干指标来源：`data_build/data/processed/data_v3_main.dta`
- 当前重建入口：`scripts/python/ggcp10_parallel_rules_69038_search.py::load_panel`
