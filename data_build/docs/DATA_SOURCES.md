...
File: `data/processed/data_v1_with_climate.csv`  
...
- Outlier handling: no winsorization or trimming rule is explicitly documented in `docs/INDEX.md` and `docs/VARIABLES.md`
