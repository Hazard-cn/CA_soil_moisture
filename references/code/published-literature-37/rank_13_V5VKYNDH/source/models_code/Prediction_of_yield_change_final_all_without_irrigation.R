...
##barley 
{
  ...
  predictor1$SCNT <-as.factor(as.character(predictor1$SCNT))
  
  predictor1$RCT <-as.factor(as.character(predictor1$RCT))
  predictor1$RNT <-as.factor(as.character(predictor1$RNT))
  
  predictor1$FCT <-as.factor(as.character(predictor1$FCT))
  predictor1$FNT <-as.factor(as.character(predictor1$FNT))
  
  predictor1$WPCT <-as.factor(as.character(predictor1$WPCT))
  predictor1$WPNT <-as.factor(as.character(predictor1$WPNT))
  
  predictor1$IrrigationCT <-as.factor(as.character(0))
  predictor1$IrrigationNT <-as.factor(as.character(0))
